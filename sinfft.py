...
#以下是str->unicode 的代码，把 str 编码由 ascii 改为 utf8 (或 gb18030)
import sys
reload(sys)
sys.setdefaultencoding('utf8')

from enthought.traits.api import Str, Float, HasTraits, Property, cached_property, Range, Instance, on_trait_change, Enum

from enthought.chaco.api import Plot, AbstractPlotData, ArrayPlotData, VPlotContainer

from enthought.traits.ui.api import Item, View, VGroup, HSplit, ScrubberEditor, VSplit
